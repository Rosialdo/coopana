...
<script>
import { mdbRow, mdbCol, mdbBtn, mdbCard, mdbCardBody, mdbCardHeader, mdbCardText, mdbIcon, mdbTbl, mdbBarChart, mdbPieChart, mdbLineChart,  mdbDoughnutChart, mdbListGroup, mdbListGroupItem, mdbBadge } from 'mdbvue'
